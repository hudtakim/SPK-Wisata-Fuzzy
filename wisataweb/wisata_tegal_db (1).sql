...
(57, 'Jenis', 'Alam', 'Sosial_budaya', 'Religi_Sejarah'),
(58, 'Harga', 'Murah', 'Sedang', 'Mahal'),
(61, 'Jarak', 'Dekat', 'Sedang', 'Jauh'),
(65, 'Luas', 'Sempit', 'Sedang', 'Longgar'),
(66, 'Keindahan', 'Jelek', 'Biasa', 'Bagus');
...
(18, 'Keindahan', 'Jelek', 'Biasa', 'Bagus', 3, 5, 8);
...
--
-- Table structure for table `fuzzy_keindahan`
--

CREATE TABLE `fuzzy_keindahan` (
  `id` int(11) NOT NULL,
  `obyek_wisata` varchar(30) NOT NULL,
...
--
-- Dumping data for table `fuzzy_keindahan`
--

INSERT INTO `fuzzy_keindahan` (`id`, `obyek_wisata`, `keindahan`, `jelek`, `biasa`, `bagus`) VALUES
...
(6, 'Yogya Waterboom', 6, 0, 0.666667, 0.2),
(7, 'Konsorsium Rumah Wayang', 7, 0, 0.333333, 0.4),
(8, 'Gerbang Mas Bahari Waterpark', 8, 0, 0, 0.6),
(9, 'Rita Park', 9, 0, 0, 1),
(10, 'Hutan Mangrove Tegal', 10, 0, 0, 1),
(11, 'Makam Ki Gede Sebayu', 2, 1, 0, 0),
(12, 'Makam Sunan Amangkurat I', 8, 0, 0, 0.6),
(13, 'Klenteng Tek Hay Kiong', 3, 1, 0, 0),
(14, 'Situs Purbakala Semedo', 7, 0, 0.333333, 0.4),
(15, 'Pool Terrace Samudra', 5, 0, 1, 0);
...
INSERT INTO `tempat_wisata_tb` (`obyek_wisata`, `jenis`, `fasilitas`, `harga`, `pengunjung`, `jarak`, `id`, `luas`, `kosong`, `keindahan`) VALUES
('Desa Wisata Guci', 'Alam', 16, 7000, 66558, 28, 1, 123, '', 1),
('Pantai Alam Indah', 'Alam', 7, 5000, 31336, 18, 2, 21, '', 2),
('Pantai Purwahamba Indah', 'Alam', 15, 3500, 29257, 25, 3, 23, '', 3),
('Waduk Cacaban', 'Alam', 6, 4000, 3833, 22, 4, 232, '', 4),
('Wisata Kesehatan Jamu Kalibaku', 'Alam', 6, 5000, 710, 14, 5, 23, '', 5),
('Yogya Waterboom', 'Sosial dan Budaya', 10, 15000, 4644, 4, 6, 23, '', 6),
('Konsorsium Rumah Wayang', 'Sosial dan Budaya', 5, 0, 1487, 11, 7, 23, '', 7),
('Gerbang Mas Bahari Waterpark', 'Sosial dan Budaya', 11, 25000, 31187, 16, 8, 232, '', 8),
('Rita Park', 'Sosial dan Budaya', 24, 60000, 25043, 15, 9, 32, '', 9),
('Hutan Mangrove Tegal', 'Alam', 2, 0, 900, 18, 10, 23, '', 10),
('Makam Ki Gede Sebayu', 'Religi dan Sejarah', 3, 0, 3888, 10, 11, 323, '', 2),
('Makam Sunan Amangkurat I', 'Religi dan Sejarah', 3, 0, 4255, 9, 12, 23, '', 8),
('Klenteng Tek Hay Kiong', 'Religi dan Sejarah', 4, 0, 5627, 16, 13, 123, '', 3),
('Situs Purbakala Semedo', 'Religi dan Sejarah', 2, 0, 649, 24, 14, 133, '', 7),
('Pool Terrace Samudra', 'Sosial dan Budaya', 7, 7500, 4411, 15, 15, 232, '', 5);
...
--
-- Indexes for table `fuzzy_keindahan`
--
ALTER TABLE `fuzzy_keindahan`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `fuzzy_keindahan`
--
ALTER TABLE `fuzzy_keindahan`
